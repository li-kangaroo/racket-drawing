...
(insert slide-11-canvas slide-11-vector (vec-pict-getter slide-11-vector) 0.1 0.1)
...
(insert slide-33-canvas struct-33a (struct-pict-getter struct-33a) 0.1 0.3)
(insert slide-33-canvas struct-33b (struct-pict-getter struct-33a) 0.6 0.1)
...
(insert slide-35-canvas slide-35-spine-vector
...
(insert slide-35-canvas 35a-struct (struct-pict-getter 35a-struct) 0.05 0.35)
(insert slide-35-canvas 35b-struct (struct-pict-getter 35b-struct) 0.25 0.35)
(insert slide-35-canvas 35c-struct (struct-pict-getter 35c-struct) 0.55 0.35)
(insert slide-35-canvas 35d-struct (struct-pict-getter 35d-struct) 0.75 0.35)
...
(insert slide-35-canvas alice
        (vec-pict-getter alice #:show-indices? false)
        0.05 0.7)
(insert slide-35-canvas bob
        (vec-pict-getter bob #:show-indices? false)
        0.3 0.85)
(insert slide-35-canvas carol
        (vec-pict-getter carol #:show-indices? false)
        0.5 0.7)
(insert slide-35-canvas dave
        (vec-pict-getter dave #:show-indices? false)
        0.75 0.85)

(point-x-to-y slide-35-canvas
              35a-struct (struct-loc-getter 35a-struct #:field "name")
              alice (vec-loc-getter alice)
              #:from-find rc-find
              #:to-find ct-find
              #:start-angle 5.8
              #:start-pull 0.5
              #:end-angle 4)
(point-x-to-y slide-35-canvas
              35b-struct (struct-loc-getter 35b-struct #:field "name")
              bob (vec-loc-getter bob)
              #:from-find rc-find
              #:to-find ct-find
              #:start-angle 5.8
              #:start-pull 0.5
              #:end-angle 4)
(point-x-to-y slide-35-canvas
              35c-struct (struct-loc-getter 35c-struct #:field "name")
              carol (vec-loc-getter carol)
              #:from-find rc-find
              #:to-find ct-find
              #:start-angle 5.8
              #:start-pull 0.5
              #:end-angle 4)
(point-x-to-y slide-35-canvas
              35d-struct (struct-loc-getter 35d-struct #:field "name")
              dave (vec-loc-getter dave)
              #:from-find rc-find
              #:to-find ct-find
              #:start-angle 5.8
              #:start-pull 0.5
              #:end-angle 4)
(point-x-to-y slide-35-canvas
              slide-35-spine-vector (vec-loc-getter slide-35-spine-vector #:content? #t #:index 0)
              35a-struct (struct-loc-getter 35a-struct)
              #:from-find lc-find
              #:to-find ct-find
              #:start-angle 3.1
              #:end-angle 4)
(point-x-to-y slide-35-canvas
              slide-35-spine-vector (vec-loc-getter slide-35-spine-vector #:content? #t #:index 1)
              35b-struct (struct-loc-getter 35b-struct)
              #:from-find cb-find
              #:to-find ct-find)
(point-x-to-y slide-35-canvas
              slide-35-spine-vector (vec-loc-getter slide-35-spine-vector #:content? #t #:index 2)
              35c-struct (struct-loc-getter 35c-struct)
              #:from-find cb-find
              #:to-find ct-find)
(point-x-to-y slide-35-canvas
              slide-35-spine-vector (vec-loc-getter slide-35-spine-vector #:content? #t #:index 3)
              35d-struct (struct-loc-getter 35d-struct)
              #:from-find rc-find
              #:to-find ct-find
              #:start-angle 0
              #:end-angle 5)
...
(insert slide-38-canvas slide-38-vector
